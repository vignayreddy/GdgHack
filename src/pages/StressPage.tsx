  ...
  return (
    <div className="max-w-4xl mx-auto space-y-16 pb-20">
      <header className="space-y-6 text-center">
        ...
        <h1 className="font-serif text-5xl md:text-7xl font-bold text-sage-700 tracking-tight">Stress Tracker</h1>
        <p className="text-stone-500 max-w-2xl mx-auto text-xl italic font-serif leading-relaxed">
          "Find your balance. Tracking stress helps you identify triggers and manage them effectively."
        </p>
      </header>
